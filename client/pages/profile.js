...
export default function Profile() {
  ...
  return (
    <>
      <Head>
        <title>Profile | RAMResume</title>
        <meta name="description" content="Manage your profile and settings here." />
        <meta property="og:title" content="Profile | RAMResume" />
        <meta property="og:description" content="Manage your profile and settings here." />
