...
export default function Onboarding() {
  ...
  return (
    <>
      <Head>
        <title>Onboarding | RAMResume</title>
        <meta
          name="description"
          content="Complete your profile and add your resume to get personalized job recommendations."
        />
        <meta property="og:title" content="Onboarding | RAMResume" />
        <meta
